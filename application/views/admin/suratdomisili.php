<main id="main" class="main">
    <div class="pagetitle">
        <h1>Pengajuan Surat Domisili</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Surat Domisili</a></li>
                <li class="breadcrumb-item active">Data Surat Domisili</li>
            </ol>
        </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Daftar Pengajuan Surat Domisili</h5>
                        ...
                        <div class="table-responsive">
                            <table class="table datatable">
                                ...
                                <tbody>
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    <li>
                                                        <a href="javascript:void(0)" class="dropdown-item"
                                                            onclick="konfirmasiDelete('<?= base_url('admin/domisili/delete/' . $item->id) ?>')">
                                                            <i class="bi bi-trash"></i> Hapus
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="<?= base_url('admin/domisili/downloadsd/'.urlencode(base64_encode($item->id_alias))) ?>"
                                                    ...
                                                    <li>
                                                        ...
                                                        <a href="javascript:void(0)" class="dropdown-item"
                                                            onclick="konfirmasiKirimWa('<?= base_url('admin/domisili/kirim_surat/'.urlencode(base64_encode($item->id_alias))) ?>')">
                                    ...
                                    <?php endforeach; ?>
                                    <?php foreach ($domisili as $item) : ?>
                                    <!-- Modal Edit Pengajuan Surat Domisili -->
                                    <div class="modal fade" id="editSuratModal<?= $item->id ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog modal-xl">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('admin/domisili/update') ?>" method="post">
...
<!-- Modal Tambah Pengajuan Surat Domisili -->
<div class="modal fade" id="tambahSuratModal" tabindex="-1" aria-labelledby="tambahSuratLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="tambahSuratLabel">Tambah Pengajuan Surat Domisili</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>

            <form action="<?= base_url('admin/domisili/add') ?>" method="post">
                <div class="modal-body">
                    <div class="row">
                        <!-- Kolom Kiri -->
                        <div class="col-md-6">

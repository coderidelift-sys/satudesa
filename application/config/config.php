...
$config['base_url'] .= "://" . strtolower($_SERVER['HTTP_HOST']);
$config['base_url'] .= str_replace(strtolower(basename($_SERVER['SCRIPT_NAME'])), "", strtolower($_SERVER['SCRIPT_NAME']));
...
$config['encryption_key_data'] = 'key_aman_rahasia_32_karakter'; // Sesuaikan dengan panjang yang aman
...
//$config['encryption_key'] = 'aD9g3#Lk@1z6Wx8NpQ4fE!uZt9oM7cRv';
